  ...
  (
    ...
    const {
      ...
      onDrop: async (acceptedFiles) => {
        ...
        if (files) {
          ...
          const addedFiles = compressedFiles.map<FileState>((file) => ({
            file,
    ...
    return (
      <div className="w-full">
        {/* Hero Section */}
        <div className="bg-blue-600 text-white py-80 text-center">
          <h1 className="text-3xl font-bold">File Upload Center</h1>
          <p className="text-lg mt-2">Upload and manage your files with ease</p>
        </div>
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                    ...
                    <div className="text-gray-400">
                      drag & drop or click to upload entire folders
                    </div>
                  </div>
                </div>
