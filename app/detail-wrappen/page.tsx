...
export default function AutoWrappenDiensten() {
  return (
    <main className="bg-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 ">
            <div>
              <Image
                ...
                alt="Voorbeeld van Detailwrappen"
                width={800}
                height={600}
                className="hover:scale-110 rounded-lg shadow-lg animate-fadeInUp "
              />
            </div>
            <div className="flex flex-col justify-center">
              ...
              <p className="text-lg mb-4 text-gray-700">
                Detailwrappen is een moderne techniek waarbij een speciale, hoogwaardige folie nauwkeurig over de buitenkant van de auto wordt aangebracht. Dit geeft u de mogelijkheid om het uiterlijk van uw voertuig volledig aan te passen, zonder permanente wijzigingen aan de originele lak.
              </p>
      ...
      {/* Hoe lang duurt het detailwrappen? */}
        ...
        <div className="container mx-auto px-4 lg:px-16 animate-fadeInUp">
          ...
          <div className="flex flex-col items-center gap-8">
            <ul className="list-none text-lg mb-6 text-gray-700 text-center">
              ...
              <li>
                <strong>Niet permanent:</strong> Anders dan spuiten, is detailwrappen niet permanent en gemakkelijk te verwijderen.
              </li>
            </ul>
            <Image
              src="/images/brabus1.png"
              alt="Voordelen van Detailwrappen"
              width={1920}
              height={1080}
              className="rounded-lg shadow-lg animate-fadeInUp"
            />
