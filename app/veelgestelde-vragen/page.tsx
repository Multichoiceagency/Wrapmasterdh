  ...
  return (
    <main className="bg-black py-16">
      <div className="container mx-auto px-4 lg:px-16 pt-10">
        <h1 className="text-4xl font text-center mb-8 bg-white px-5 py-6 rounded-xl">Veelgestelde Vragen (FAQ)</h1>
        ...
        <Accordion type="single" collapsible className="bg-white p-8 rounded-lg shadow-lg space-y-4">
          ...
          <AccordionItem value="auto-wrappen">
            <AccordionTrigger className="text-2xl font">Auto Wrappen</AccordionTrigger>
            <AccordionContent>
              <h3 className="text-xl font mb-4">Wat is auto wrappen precies?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat zijn de voordelen van auto wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang gaat een auto wrap mee?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan een auto wrap worden verwijderd?</h3>
              ...
              <h3 className="text-xl font mb-4">Beschermt auto wrappen de originele lak van mijn voertuig?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang duurt het om een auto te wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik kiezen uit verschillende kleuren voor een auto wrap?</h3>
              ...
              <h3 className="text-xl font mb-4">Is een matte of glanzende afwerking beter voor een auto wrap?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat zijn de kosten voor het wrappen van een auto?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe onderhoud ik mijn auto wrap?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik mijn auto door de wasstraat laten gaan met een wrap?</h3>
              ...
              <h3 className="text-xl font mb-4">Verkleurt een auto wrap door de zon?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe vaak moet een auto wrap worden vervangen?</h3>
              ...
              <h3 className="text-xl font mb-4">Is auto wrappen duurder dan overspuiten?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik een deel van mijn auto laten wrappen, zoals de motorkap?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat gebeurt er als de auto wrap beschadigd raakt?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik mijn auto zelf wrappen of moet dit professioneel worden gedaan?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang duurt het om een auto wrap te verwijderen?</h3>
              ...
              <h3 className="text-xl font mb-4">Welke delen van mijn auto kan ik laten wrappen?</h3>
          ...
          <AccordionItem value="detail-wrappen">
            <AccordionTrigger className="text-2xl font">Detail Wrappen</AccordionTrigger>
            <AccordionContent>
              <h3 className="text-xl font mb-4">Wat is detail wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat zijn de voordelen van detail wrappen in vergelijking met volledige wraps?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik alleen mijn spiegels laten wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat zijn populaire delen van de auto om te detail wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang gaat een detail wrap mee?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik verschillende kleuren combineren in een detail wrap?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang duurt het om een detail wrap aan te brengen?</h3>
              ...
              <h3 className="text-xl font mb-4">Beschermt een detail wrap ook de lak van mijn auto?</h3>
              ...
              <h3 className="text-xl font mb-4">Zijn er speciale onderhoudstips voor detail wraps?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoeveel kost het om detail wrapping toe te passen op mijn auto?</h3>
          ...
          <AccordionItem value="chrome-delete">
            <AccordionTrigger className="text-2xl font">Chrome Delete</AccordionTrigger>
            <AccordionContent>
              <h3 className="text-xl font mb-4">Wat is Chrome Delete?</h3>
              ...
              <h3 className="text-xl font mb-4">Waarom zou ik kiezen voor Chrome Delete?</h3>
              ...
              <h3 className="text-xl font mb-4">Welke delen van de auto kunnen worden behandeld met Chrome Delete?</h3>
              ...
              <h3 className="text-xl font mb-4">Is Chrome Delete permanent?</h3>
              ...
              <h3 className="text-xl font mb-4">Beschermt Chrome Delete mijn auto tegen roest?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan Chrome Delete worden verwijderd zonder schade aan te richten?</h3>
              ...
              <h3 className="text-xl font mb-4">Welke kleuren zijn beschikbaar voor Chrome Delete?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang duurt het om Chrome Delete toe te passen?</h3>
              ...
              <h3 className="text-xl font mb-4">Heeft Chrome Delete invloed op de garantie van mijn auto?</h3>
          ...
          <AccordionItem value="reclame-belettering">
            <AccordionTrigger className="text-2xl font">Reclame Belettering</AccordionTrigger>
            <AccordionContent>
              <h3 className="text-xl font mb-4">Wat is reclame belettering?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan reclame belettering op elk voertuig worden aangebracht?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat zijn de voordelen van reclame belettering voor mijn bedrijf?</h3>
              ...
              <h3 className="text-xl font mb-4">Is reclame belettering waterbestendig?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang blijft reclame belettering op een voertuig zitten?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik elk ontwerp laten printen als reclame belettering?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat kost reclame belettering voor een voertuig?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang duurt het om reclame belettering aan te brengen?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan reclame belettering ook op boten worden aangebracht?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe onderhoud ik mijn voertuig met reclame belettering?</h3>
          ...
          <AccordionItem value="scooter-wrappen">
            <AccordionTrigger className="text-2xl font">Scooter Wrappen</AccordionTrigger>
            <AccordionContent>
              <h3 className="text-xl font mb-4">Kan ik mijn scooter laten wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat zijn de voordelen van scooter wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Beschermt scooter wrappen mijn scooter tegen krassen?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik mijn scooter in verschillende kleuren laten wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoeveel kost het om een scooter te laten wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang gaat een scooter wrap mee?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik mijn scooter door de wasstraat laten gaan met een wrap?</h3>
              ...
              <h3 className="text-xl font mb-4">Is scooter wrappen duurder dan overspuiten?</h3>
              ...
              <h3 className="text-xl font mb-4">Hoe lang duurt het om een scooter te wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Kan ik mijn scooter wrap laten verwijderen zonder de lak te beschadigen?</h3>
          ...
          <AccordionItem value="motor-wrappen">
            <AccordionTrigger className="text-2xl font">Motor Wrappen</AccordionTrigger>
            <AccordionContent>
              <h3 className="text-xl font mb-4">Is het mogelijk om een motor te wrappen?</h3>
              ...
              <h3 className="text-xl font mb-4">Wat zijn de voordelen van motor wrappen in vergelijking met spuiten?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan ik mijn motor in meerdere kleuren laten wrappen?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe lang duurt het om een motor te wrappen?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe lang blijft een motor wrap goed?</h3>
    ...
    <h3 className="text-xl font mb-4">Is motor wrappen bestand tegen weersomstandigheden?</h3>
    ...
    <h3 className="text-xl font mb-4">Beschermt motor wrappen de lak van mijn motor?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoeveel kost het om een motor te wrappen?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan ik mijn motor wrap zelf verwijderen?</h3>
    ...
    <h3 className="text-xl font mb-4">Wat gebeurt er als mijn motor wrap beschadigd raakt?</h3>
...
<AccordionItem value="koplampen-tinten">
  <AccordionTrigger className="text-2xl font">Koplampen Tinten</AccordionTrigger>
  <AccordionContent>
    <h3 className="text-xl font mb-4">Waarom zou ik mijn koplampen laten tinten?</h3>
    ...
    <h3 className="text-xl font mb-4">Zijn getinte koplampen legaal?</h3>
    ...
    <h3 className="text-xl font mb-4">Welke kleuren zijn beschikbaar voor koplamp tinten?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe lang duurt het om koplampen te tinten?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan koplampen tinten de zichtbaarheid beïnvloeden?</h3>
    ...
    <h3 className="text-xl font mb-4">Beschermt tinten de koplampen tegen schade?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoeveel kost het om mijn koplampen te tinten?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe onderhoud ik getinte koplampen?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan ik de tint van mijn koplampen later verwijderen?</h3>
...
<AccordionItem value="velgen-remklauwen-spuiten">
  <AccordionTrigger className="text-2xl font">Velgen & Remklauwen Spuiten</AccordionTrigger>
  <AccordionContent>
    <h3 className="text-xl font mb-4">Wat zijn de voordelen van het spuiten van velgen en remklauwen?</h3>
    ...
    <h3 className="text-xl font mb-4">Welke kleuren kan ik kiezen voor velgen en remklauwen?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe lang blijft de kleur op mijn velgen en remklauwen zitten?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoeveel kost het om velgen en remklauwen te laten spuiten?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe lang duurt het om mijn velgen en remklauwen te spuiten?</h3>
    ...
    <h3 className="text-xl font mb-4">Beschermt het spuiten van velgen en remklauwen tegen corrosie?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan ik mijn velgen en remklauwen zelf laten spuiten?</h3>
    ...
    <h3 className="text-xl font mb-4">Is spuiten beter dan het aanbrengen van folie op velgen?</h3>
    ...
    <h3 className="text-xl font mb-4">Moet ik mijn velgen en remklauwen regelmatig laten bijwerken?</h3>
    ...
    <h3 className="text-xl font mb-4">Verkleurt de verf op remklauwen door hitte?</h3>
...
<AccordionItem value="wrapfolie-verwijderen">
  <AccordionTrigger className="text-2xl font">Wrapfolie Verwijderen</AccordionTrigger>
  <AccordionContent>
    <h3 className="text-xl font mb-4">Hoe wordt wrapfolie veilig verwijderd?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan wrapfolie worden verwijderd zonder schade aan de lak?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe lang duurt het om wrapfolie te verwijderen?</h3>
    ...
    <h3 className="text-xl font mb-4">Wat gebeurt er als er lijmresten achterblijven na het verwijderen van wrapfolie?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan ik zelf mijn wrapfolie verwijderen?</h3>
    ...
    <h3 className="text-xl font mb-4">Is het verwijderen van wrapfolie duurder dan het aanbrengen ervan?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe vaak kan ik wrapfolie vervangen op mijn auto?</h3>
    ...
    <h3 className="text-xl font mb-4">Beschadigt het verwijderen van wrapfolie mijn lak als deze al oud is?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan wrapfolie ook van ramen worden verwijderd?</h3>
    ...
    <h3 className="text-xl font mb-4">Moet ik mijn auto opnieuw laten polijsten na het verwijderen van wrapfolie?</h3>
...
<AccordionItem value="velgenbescherming">
  <AccordionTrigger className="text-2xl font">Velgenbescherming</AccordionTrigger>
  <AccordionContent>
    <h3 className="text-xl font mb-4">Wat is velgenbescherming?</h3>
    ...
    <h3 className="text-xl font mb-4">Waarom zou ik mijn velgen laten beschermen?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe wordt velgenbescherming aangebracht?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoeveel kost velgenbescherming?</h3>
    ...
    <h3 className="text-xl font mb-4">Beschermt velgenbescherming tegen stoeprandschade?</h3>
    ...
    <h3 className="text-xl font mb-4">Is velgenbescherming zichtbaar op de velgen?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan ik velgenbescherming laten verwijderen?</h3>
    ...
    <h3 className="text-xl font mb-4">Verkleurt velgenbescherming door zonlicht?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe lang duurt het om velgenbescherming aan te brengen?</h3>
    ...
    <h3 className="text-xl font mb-4">Is velgenbescherming ook geschikt voor aluminium velgen?</h3>
...
<AccordionItem value="sterrenhemel">
  <AccordionTrigger className="text-2xl font">Sterrenhemel</AccordionTrigger>
  <AccordionContent>
    <h3 className="text-xl font mb-4">Wat is een sterrenhemel in een auto?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe wordt een sterrenhemel geïnstalleerd in een auto?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan ik de kleur van de sterrenhemel aanpassen?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoeveel kost het om een sterrenhemel te laten installeren?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe lang duurt het om een sterrenhemel te installeren?</h3>
    ...
    <h3 className="text-xl font mb-4">Is de sterrenhemel energiezuinig?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan de sterrenhemel worden verwijderd zonder schade?</h3>
    ...
    <h3 className="text-xl font mb-4">Hoe onderhoud ik een sterrenhemel in mijn auto?</h3>
    ...
    <h3 className="text-xl font mb-4">Kan ik de intensiteit van de sterrenhemel aanpassen?</h3>
    ...
    <h3 className="text-xl font mb-4">Is een sterrenhemel alleen geschikt voor luxe auto&apos;s?</h3>
    <p className="text-lg text-gray-700">Nee, een sterrenhemel kan in bijna elk type voertuig worden geïnstalleerd, van luxe auto&apos;s tot kleinere voertuigen, afhankelijk van de beschikbare ruimte in het dak.</p>
        ...
        <div className="bg-red-600 text-white text-center py-8 mt-12 rounded-lg">
          <h2 className="text-3xl font mb-4">Heb je nog vragen?</h2>
          ...
          <Link href="/contact" className="inline-block px-6 py-3 bg-white text-red-600 font rounded-lg hover:bg-gray-100 transition">
            Neem Contact Op
          </Link>
        </div>
      </div>
