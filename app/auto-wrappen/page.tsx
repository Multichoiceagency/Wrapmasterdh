  ...
  return (
    <main className="bg-gray-100">
        ...
        <div className="container mx-auto px-4 lg:px-16 animate-fadeInUp">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="flex flex-col justify-center order-2 lg:order-1">
              <h2 className="text-3xl font-bold mb-8 text-left">Hoe lang duurt het wrappen?</h2>
              <p className="text-lg mb-4 text-gray-700">
              ...
              <h4 className="text-2xl font-bold mb-4">Standaard Auto Wrappen</h4>
              <p className="text-lg mb-6 text-gray-700">
      ...
      <section id="kosten-wrappen" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 lg:px-16 animate-fadeInUp">
          <h2 className="text-3xl font-bold mb-8 text-center">Wat kost een auto wrappen?</h2>
      ...
      <section id="voordelen" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 lg:px-16 animate-fadeInUp">
          <h2 className="text-3xl font-bold mb-8 text-center">De Voordelen van Auto Wrappen</h2>
